...
%============================================================================a========================
    \begin{abstractpage}{Zusammenfassung}
        ...
        Diese vollständige Rekonstruktion ermöglicht den Rückschluss auf den Impuls und die Energie des Signal-\B-Mesons durch eine Technik, die als Hadronisch-Tagging bezeichnet wird.
        ...
        Nur das hochenergetische Photon aus dem Signal des \B-Meson-Zerfalls wird rekonstruiert, um ein unverzerrtes, umfassendes Sample von Endzuständen zu erhalten, an denen Strange-Hadronen beteiligt sind. 
        Die kinematische Einschränkung durch das Hadronen-Tagging ermöglicht einen direkten Zugang zum Signal-\B-Meson-Ruhezustand, was zu einer besseren Empfindlichkeit gegenüber dem Photonen-Energiespektrum führt, ohne die zusätzliche Verschmierung, die im $\Upsilon(4S)$-Ruhezustand beobachtet wird.
        ...
        Der integrierte Verzweigungsverhältnisse in diesem Bereich beträgt \mbox{$(3.54 \pm 0.78~(\mathrm{stat.}) \pm 0.83~(\mathrm{sys.}))\cdot10^{-4}$}.
        Zusätzlich werden die ersten und zweiten Momente des Photonenenergiespektrums für mehrere Schwellenwerte in der Photonenenergie berechnet. 
        ...
        Die Ergebnisse zeigen eine hervorragende Übereinstimmung mit den Vorhersagen des Standardmodells und dienen als Proof-of-Concept für zukünftige Messungen von radiativen \BtoXsgamma Zerfällen mit Hadronisch-Tagging an Belle~II.
    \end{abstractpage}
%====================================================================================================
