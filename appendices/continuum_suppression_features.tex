...
The tests in \Cref{sec:thrusts,sec:sphericity_aplanarity,sec:harmonic_moments,sec:fox_wolfram_moments,sec:modified_fox_wolfram_moments,sec:cleo_cones,sec:angular_features,sec:vertex_features,sec:flavour_tagger_outputs}
provide a sample of XX variables, which then undergo the additional agreement test requirements, named \textbf{Test~2} (see \Cref{sec:continuum_features}).
