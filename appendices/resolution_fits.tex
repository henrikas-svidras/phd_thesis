...
\begin{figure}[htbp!]
    ...
    on the hybrid signal-model data set where good tag-\B mesons are used for \EB reconstruction.
...
\begin{figure}[htbp!]
    ...
    on the hybrid signal-model data set where only perfectly reconstructed tag-\B mesons are used for \EB reconstruction.
    The parameter $\sigma$, corresponding to the width of the central Gaussian part is evaluated.
    This parameter is equated to the resolution of \EB in this analysis.
