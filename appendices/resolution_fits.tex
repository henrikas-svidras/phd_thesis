...
The quantity from \Cref{eq:resolution} is fitted with a double-sided Crystal Ball function.
...
The hybrid signal-model samples are fitted, where a good tag-\B meson (based on \Cref{fig:good_tag_definitions}, 
...
The former visualised in \Cref{fig:resolution_fits}, wheras the latter in \Cref{fig:issignal_resolution_fits}.
The estimated parameters $\sigma$ and their corresponding uncertainties estimated by the fitter are then summarised in \Cref{fig:resolution_sigmas}.
In \Cref{sec:resolution_studies} further discussion follows.

\begin{figure}[htbp!]
    \centering
    \subcaptionbox{\label{fig:res_1p4}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/1p4to1p6.pdf}
    }
    \subcaptionbox{\label{fig:res_1p6}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/1p4to1p6.pdf}
    }
    \subcaptionbox{\label{fig:res_1p8}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/1p6to1p8.pdf}
    }
    \subcaptionbox{\label{fig:res_2p0}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/1p8to2p0.pdf}
    }
    \subcaptionbox{\label{fig:res_2p1}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p0to2p1.pdf}
    }
    \subcaptionbox{\label{fig:res_2p2}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p1to2p2.pdf}
    }
    \subcaptionbox{\label{fig:res_2p3}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p2to2p3.pdf}
    }
    \subcaptionbox{\label{fig:res_2p4}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p3to2p4.pdf}
    }
    \subcaptionbox{\label{fig:res_2p5}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p4to2p5.pdf}
    }
    \subcaptionbox{\label{fig:res_2p6}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/2p5to2p6.pdf}
    }
...
\begin{figure}[htbp!]
    ...
    \subcaptionbox{\label{fig:issignal_res_1p4}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_1p4to1p6.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_1p6}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_1p4to1p6.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_1p8}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_1p6to1p8.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p0}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_1p8to2p0.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p1}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p0to2p1.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p2}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p1to2p2.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p3}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p2to2p3.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p4}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p3to2p4.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p5}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p4to2p5.pdf}
    }
    \subcaptionbox{\label{fig:issignal_res_2p6}}{
        \includegraphics[width=0.3\textwidth]{figures/appendices/resolution_fits/issignal_2p5to2p6.pdf}
    }
