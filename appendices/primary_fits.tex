...
The \Mbc fits on each \EB bi (see \Cref{sec:binning}) for the aforementioned components of the dataset is provided in this Chapter.
...
Additionally, the ARGUS and Chebyshev \PDF{s} are combined after fitting and a good combined description of the background is achieved.
