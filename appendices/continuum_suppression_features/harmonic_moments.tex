...
\begin{figure}[htbp!]
    \subcaptionbox{\label{fig:harmonicMomentumThrust0}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/harmonic_moments/harmonicMomentThrust0_bias_tested.pdf}
    }
    \subcaptionbox{\label{fig:harmonicMomentumThrust1}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/harmonic_moments/harmonicMomentThrust1_bias_tested.pdf}
...
\begin{figure}[htbp!]
    ...
    \subcaptionbox{\label{fig:harmonicMomentumThrust2}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/harmonic_moments/harmonicMomentThrust2_bias_tested.pdf}

    }
    \subcaptionbox{\label{fig:harmonicMomentumThrust3}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/harmonic_moments/harmonicMomentThrust3_bias_tested.pdf}

    }
    \subcaptionbox{\label{fig:harmonicMomentumThrust4}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/harmonic_moments/harmonicMomentThrust4_bias_tested.pdf}
    }
