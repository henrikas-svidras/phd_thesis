...
`Thrust'-like observables can be utilised to distinguish \epem\ra\qqbar and \BtoXsgamma events following the same argument as the one sketched in \Cref{fig:continuum_schematic}.
...
\begin{itemize}
    ...
    and the thrust of all the other particles (\Cref{fig:cosTBTO});
...
\begin{figure}[htbp!]
    \subcaptionbox{\label{fig:cosTBTO}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/Btag_cosTBTO_bias_tested.pdf}
    }
    \subcaptionbox{\label{fig:cosTbz}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/Btag_cosTBz_bias_tested.pdf}

    }
    \subcaptionbox{\label{fig:thrustBm}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/Btag_thrustBm_bias_tested.pdf}
...
\begin{figure}[htbp!]
    ...
    \subcaptionbox{\label{fig:thrustOm}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/Btag_thrustOm_bias_tested.pdf}

    }
    \subcaptionbox{\label{fig:thrust}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/thrust_bias_tested.pdf}
    }
    \subcaptionbox{\label{fig:thrustAxisCosTheta}}{
        \includegraphics[width=1\textwidth]{figures/appendices/continuum_suppression_features/thrust/thrustAxisCosTheta_bias_tested.pdf}
    }
