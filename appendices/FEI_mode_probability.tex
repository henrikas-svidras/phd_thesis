...
This is discussed in the comparison between \feiBp and \feiBz modes in \Cref{sec:reconstruction_overview}.
However, even for specific channels for given $B$ modes \feiProb is not a well-calibrated quantity.
This is shown in \Cref{fig:feisigprobs2} for \Bp modes and \Cref{fig:feisigprobs4} for \Bz modes.
