...
\begin{table}[hbtp!]
    \centering
    \caption{\label{tab:cutflow} The summary of all selections and their retentions, based on \Cref{eq:loose_efficiency}.
...
The background suppression procedure, shown in \Cref{tab:cutflow}, roughly halves the number of available \BtoXsgamma events in the sample.
...
The photon energy spectrum, after these selections, is shown in \Cref{fig:spectrum_after_optimisation}.
Compared with the previous versions of this Figure, e.g. \Cref{fig:spectrum_after_reco}, a much better signal-to-background ratio is obtained.
