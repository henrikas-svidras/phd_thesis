...
For each two parameters a 2-dimensional figure is created and a correlation coefficient is evaluated.
This results in a 36-by-36 matrix, corresponding to all parameters estimated by the \Mbc fitter in this analysis.