...
The results of hyper-parameter optimisation are summarised in \Cref{tab:grid_search} and shown in \Cref{fig:hyper_param}
...
\begin{figure}[htbp!]
    ...
    \caption{\label{fig:hyper_param}Hyper-parameter optimisation as a function of quantities defined in \Cref{eq:optimisation_criteria}.
