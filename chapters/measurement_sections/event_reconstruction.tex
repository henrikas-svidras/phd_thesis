...
% \begin{table}[htbp!]
%     \caption{\label{tab:grid_photon_fei} Fraction of events where the $i$th ranked tag-side candidate.}
%     \input{tables/selected_photons_tags.tex}
% \end{table}
...
\begin{figure}[htbp!]
    ...
    \caption{\label{fig:photon_reco_candidates} Relative fractions of events for the number of reconstructed \B meson candidates.
    }
\end{figure}
...
\begin{figure}[htbp!]
    ...
    \caption{\label{fig:spectrum_after_reco} \BtoXsgamma after reco.
    }
\end{figure}
\todo[inline]{Do I want to say on the plot that is feihadronicbplus vs bzero? Maybe ok as it is}
