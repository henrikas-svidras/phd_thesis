...
\begin{figure}[htbp!]
    ...
    The inclusive $X_s$ model based on \Cref{eq:simba_result_kinetic} is shown in \Cref{fig:hybrid_uncertainty}.
    ...
    The correlation of the total uncertainty is given in \Cref{fig:hybrid_uncertainty_correlation}.
    }
\end{figure}
