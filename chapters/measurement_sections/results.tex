All the discussion thus far involved either \MC samples, Belle~II data samples with negligible \BtoXsgamma events,
...
Together with fits in \Cref{fig:sideband_data_fit}, it gives all the data fits for the defined \EB intervals in \Cref{sec:binning}.
...
\begin{figure}[htbp!]
    ...
    \caption{\label{fig:final_fit_results}
        The results of fits in \Cref{fig:sideband_data_fit,fig:sideband_mc_fit,fig:data_fits_signal,fig:nosignal_fits_signal}.
        ...
        \Cref{fig:final_fit_results_lin} show the results in a linear, whereas \Cref{fig:final_fit_results_log} in a logarithmic scale.
...
The statistical and systematic uncertainty is included, where the latter is broken down into four categories presented in \Cref{sec:systematic_uncertainty}.
...
\begin{figure}[htbp!]
    ...
    \Cref{fig:partial_branching_fraction} shows the partial branching fractions of \BtoXsgamma 
...
The results presented in \Cref{sec:results} are the main result of the analysis.
...
\begin{table}[htbp!]
    ...
    They are evaluated by a weighted sum of the partial branching fractions in \Cref{tab:partial_branching_fractions} according to \Cref{eq:weighted_sum_moments}.
    The systematic and statistical uncertainties are denoted in the brackets.
    }
