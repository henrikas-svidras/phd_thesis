...
Together with fits in \Cref{fig:sideband_data_fit}, it gives all the data fits for the \EB intervals defined in \Cref{sec:binning}.
...
To this end, observed \BtoXsgamma events are corrected for efficiency and unfolded.
...
because the corresponding unfolding factor is 0 (see \Cref{tab:unfolding_uncertainties}).
