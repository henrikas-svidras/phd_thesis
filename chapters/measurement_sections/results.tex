...
The fit results on the Belle~II simulation, with all \BtoXsgamma events removed, are shown in \Cref{fig:nosignal_fits_signal}.
...
\begin{figure}[htbp!]
    ...
    \Cref{fig:partial_branching_fraction} shows th partial branching fractions of \BtoXsgamma 
