...
the fits of the signal region in Belle~II data are performed.
...
The Figure also includes results from fits of Belle~II \MC with all \BtoXsgamma events removed (\Cref{fig:sideband_mc_fit,fig:nosignal_fits_signal}).
...
The excess observed in Belle~II data fits over background-only Belle~II \MC fits is attributed to the presence of \BtoXsdgamma events.
...
are largely statistically dominated in high \EB intervals.
The systematic uncertainty is more comparable in the low-\EB intervals, with background and fit modelling uncertainties being the dominant systematic errors in the low-\EB region.
On the other hand, signal selection modelling and unfolding uncertainties become the leading systematic errors at high-\EB.
These observations are consistent with the fact that the signal-to-background ratio grows with increasing \EB (as seen in e.g. \Cref{tab:expected_events}),
