...
The fit on data is performed with and without the \Mbc correction introduced, with the two fit models in \Cref{tab:fitting_init_params,tab:fitting_init_params_updated}, respectively.
