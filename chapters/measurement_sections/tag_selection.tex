...
\begin{figure}[htbp!]
    ...
    The relative fractions of events for the number of \B meson candidates in the generic \MC dataset after the background suppression selections in \Cref{tab:cutflow}.
...
\begin{figure}[htbp!]
    ...
    The \Mbc shapes for \BtoXsgamma signal \MC (\Cref{fig:bp_mbc_mode_best_tag_selection,fig:bz_mbc_mode_best_tag_selection}) 
...
\begin{figure}[htbp!]
    ...
    \caption{\label{fig:good_tag_definitions} \Mbc distributions of \BtoXsgamma split by good/bad kinematic constraint criterion (\Cref{fig:goodbad_comparison})
