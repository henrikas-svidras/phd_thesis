...
The full analysis procedure using simulation is defined and produces an unbiased, stable result in \Cref{sec:MC_validation}.
Then, \Cref{sec:corrections} looked at the corrections required to accurately correct differences expected in \MC to better represent data.
...
All the corrections for \piz and $\eta$ veto, in addition to the \FEI calibration, are applied as discussed in \Cref{sec:corrections}.
The full analysis selection procedure involving the most optimal selections and the best tag-side candidate selection is applied, as presented in \Cref{sec:selection_summary,sec:select_best_candidate}.
...
\begin{figure}[hbtp!]
    ...
    Good agreement is observed in \feiBp (\subref{fig:bplus_offresonance_eb}), \feiBz (\subref{fig:bzero_offresonance_eb})
    and the combined sample (\subref{fig:bboth_offresonance_eb}).
    The uncertainty for data contains only the statistical component.
    The \MC also contains systematic uncertainties corresponding to \Cref{tab:correction_table}.
    }
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    Adequate agreement is observed in \feiBp (\subref{fig:bplus_offresonance_eb}), \feiBz (\subref{fig:bzero_offresonance_eb})
    and the combined sample (\subref{fig:bboth_offresonance_eb}).
    The uncertainty for data contains only the statistical component.
    The \MC uncertainty also contains systematic uncertainties corresponding to \Cref{tab:correction_table}.
    }
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    Some clear differences in \feiBp (\subref{fig:Bplus_qqbar_enhanced_mbc}), \feiBz (\subref{fig:Bzero_qqbar_enhanced_mbc}),
    and the combined sample (\subref{fig:Bboth_qqbar_enhanced_mbc}) can be observed.
...
These differences are understood as a result of data-taking period independent simulation used in this analysis.
...
The \Mbc endpoint is directly affected by $\sqrt{s}$, as seen in \Cref{eq:mbc_exclusive}, with lower values of $\sqrt{s}$ pushing the \Mbc threshold lower.
...
This is seen when comparing \Cref{fig:qqbar_enhanced_mbccorrected} and \Cref{fig:qqbar_enhanced_mbc}.
...
\begin{figure}[hbtp!]
    ...
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_1p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_1p4to1p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_1p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_1p6to1p8ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_1p8}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_1p8to2p0ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p0}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p0to2p1ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p1}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p1to2p2ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p2}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p2to2p3ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p3}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p3to2p4ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p4to2p5ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p5}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p5to2p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p6to2p7ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_qqbar_ehnhanced_data_2p7}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/qqbar_ehnaced_fits/full_MbcFit_2p7to5p0ppdf.pdf}
    }
    \caption{\label{fig:mbc_qqbar_ehnhanced_fits}The fits of Belle~II data set corresponding to 189~\invfb with selections that enhance \epem\ra\qqbar events, as discussed in \Cref{sec:continuum_mbc_validation}.
...
\begin{figure}[hbtp!]
    ...
    \subcaptionbox{\label{fig:Bplus_bbbar_enhanced_eb}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/Bplus_bbbar_enhanced_eb.pdf}
    }
    \subcaptionbox{\label{fig:Bzero_bbbar_enhanced_eb}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/Bzero_bbbar_enhanced_eb.pdf}
    }
    \subcaptionbox{\label{fig:Bboth_bbbar_enhanced_eb}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/Bboth_bbbar_enhanced_eb.pdf}
    }
    ...
    Overall, the data-simulation agreement is excellent and this is attributed to the fact that continuum events, which were accredited to causing a discrepancy in \Cref{sec:continuum_mbc_validation}, are highly suppressed in the \BB-background enhanced sample.
    The uncertainties in data are statistical, whereas \MC includes statistical and systematic uncertainties from the corrections in \Cref{tab:correction_table}.
    }
\end{figure}
...
In particular, one can see that the agreement between data and \MC is closer than what was observed in \Cref{sec:continuum_mbc_validation}.
...
Observing the Data/\MC ratio distribution in the subpanel of \Cref{fig:bbbar_enhanced_mbccorrected} it is clear that, generally, fewer events seem to be present in the peak region and more in the tail region.
...
\begin{figure}[hbtp!]
    ...
    The uncertainties in data are statistical, whereas \MC also includes systematic uncertainties from the corrections in \Cref{tab:correction_table}.
    }
\end{figure}

Finally, a fit of the \BB-enhanced \Mbc distributions is performed, according to the corrected \Mbc fitting model in \Cref{tab:fitting_init_params_updated}.
Unlike in \Cref{fig:mbc_qqbar_ehnhanced_fits}, the number of expected \BB events is no longer negligible.
Therefore, this validation serves as a test of the fit bias and the background subtraction procedure.
The \Mbc fits of Belle~II \MC and data are shown in \Cref{fig:mbc_bbar_ehnhanced_fits_mc,fig:mbc_bbar_ehnhanced_fits_data}, respectively.
...
\begin{figure}[hbtp!]
    ...
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_1p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_1p4to1p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_1p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_1p6to1p8ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_1p8}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_1p8to2p0ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p0}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p0to2p1ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p1}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p1to2p2ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p2}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p2to2p3ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p3}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p3to2p4ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p4to2p5ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p5}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p5to2p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p6to2p7ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_mc_2p7}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/MC_MbcFit_2p7to5p0ppdf.pdf}
    }
    \caption{\label{fig:mbc_bbar_ehnhanced_fits_mc}
    The fits of Belle~II \MC corresponding to 1.6~\invab with the selection 
    that enhances non-\BtoXsgamma events, as discussed in \Cref{sec:bb_background_validation}.
...
\begin{figure}[hbtp!]
    ...
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_1p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_1p4to1p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_1p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_1p6to1p8ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_1p8}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_1p8to2p0ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p0}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p0to2p1ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p1}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p1to2p2ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p2}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p2to2p3ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p3}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p3to2p4ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p4}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p4to2p5ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p5}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p5to2p6ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p6}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p6to2p7ppdf.pdf}
    }
    \subcaptionbox{\label{fig:mbc_bbar_ehnhanced_data_2p7}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/bbbar_enhanced_fits/DATA_MbcFit_2p7to5p0ppdf.pdf}
    }
...
Correcting the simulation based on \Cref{tab:correction_table} with inverted \piVeto and \etaVeto correction, as reported in \Cref{eq:correction_transform}, and calculating $\mathcal{N}_{\mathrm{CB}}^{\mathrm{DATA}} - \mathcal{N}_{\mathrm{CB}}^{\mathrm{MC}}$is expected to yield a value consistent with zero.
The resulting difference, with appropriate statistical and systematic uncertainties applied, is shown in \Cref{fig:bbar_enhanced_background_subtraction}.
...
\begin{figure}[hbtp!]
    ...
    The difference between the number of good tag-\B meson counts extracted from fits in Belle~II \MC (\Cref{fig:mbc_bbar_ehnhanced_fits_mc}) and that in Belle~II data (\Cref{fig:mbc_bbar_ehnhanced_fits_data}) in the \BB-background enhanced samples (see \Cref{sec:bb_background_validation}).
...
As discussed in \Cref{sec:binning}, the $\EB\in(1.4-1.8)~\gev$ and $\EB>2.7~\gev$ intervals are selected as sideband regions, 
...
seemingly similar to that observed in \Cref{fig:qqbar_enhanced_eb_validation}.
...
\begin{figure}[hbtp!]
    ...
    The uncertainties in data are statistical, whereas \MC includes systematic uncertainties from the corrections in \Cref{tab:correction_table}.
    }
\end{figure}
\begin{figure}[hbtp!]
    \centering
    ...
    \subcaptionbox{\label{fig:sidebands_mbc3}}{
        \includegraphics[width=0.31\textwidth]{figures/data_validation/sidebands_mbc_3.pdf}
    }
...
The results of \Cref{fig:sidebands_eb,fig:sidebands_mbc} indicate that Belle~II data, especially the low-\Mbc region, has a clear excess compared to \MC.
...
In particular, consider the removal of the \texttt{zernikeMVA} selection.
...
Indeed, even considering the \Mbc distribution for $\EB\in(1.4,1.6)~\gev$ in \Cref{fig:sideband_mbc_nozmva}, one observes a better overall agreement.
...
\begin{figure}[hbtp!]
    ...
    \caption{\label{fig:nozmva_test}   The \EB distributions in the \EB sideband region (\subref{fig:sideband_eb_nozmva})
    and the \Mbc distribution in $1.4<\EB<1.6~\gev$ regions (\subref{fig:sideband_mbc_nozmva}).
    In both cases, the requirement on the $\mathtt{zernikeMVA}$ is removed 
    to compare with \Cref{fig:Bboth_sidebands_eb,fig:sidebands_mbc3}, respectively.
    The full range of the \ZMVA distribution is shown in (\subref{fig:zmva_discrepancy}).
...
Independent studies of the \ZMVA distributions, performed similarly to the photon detection efficiency study described in \Cref{sec:photon_efficiency}, did not indicate the presence of such a peak.
...
The validity of such an assumption is tested by performing the \Mbc fit of the full sample of data. 
The results from the signal region, $\EB\in(1.8,2.7)$ remain blinded at this stage.
The individual \Mbc fits of the \EB sideband regions are shown for data in \Cref{fig:sideband_data_fit}, and for \MC in \Cref{fig:sideband_mc_fit}.
\begin{figure}[hbtp!]
    \centering
...
Subtracting the background expectation from the good tag-\B meson count in data results in \Cref{fig:sidebands_subtracted}.
...
\begin{figure}[hbtp!]
    ...
    The results with no correction factor applied are seen in (\subref{fig:sidebands_subtracted}). 
    An 8.7\% scaling factor for the simulated background values is included in (\subref{fig:sidebands_subtracted_corrected}).
    The signal region, denoted by the shaded area, is blinded at this stage.
    In this analysis, it is chosen to scale the background (i.e. the scenario shown in (\subref{fig:sidebands_subtracted_corrected})),
    as that region is expected to contain no \BtoXsgamma events.
    This Figure only includes systematic uncertainties related to corrections described in \Cref{sec:corrections}.
    }
\end{figure}
...
The scaled and background-subtracted data fit yields are shown in \Cref{fig:sidebands_subtracted_corrected}.
