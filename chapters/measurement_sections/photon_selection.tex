...
\begin{figure}[htbp!]
    ...
    in the upper panels (\Cref{fig:bp_zmva_correlation,fig:bp_piveto_correlation,fig:bp_etaveto_correlation}),
    and for \BztoXsgamma in the lower ones (\Cref{fig:bz_zmva_correlation,fig:bz_piveto_correlation,fig:bz_etaveto_correlation}).
