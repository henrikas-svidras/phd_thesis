...
The general idea of the \piz~and~\eta~veto is to pair the high energy photon signal candidate (\textit{hard} photon) candidate with lower energy photons (\textit{soft} photons) in the event.
