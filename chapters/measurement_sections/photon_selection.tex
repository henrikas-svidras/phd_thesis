...
\todo[inline]{ref to validation here}
...
The exact selections on these observables will be optimised simultaneously with continuum event suppression in XXXX.

\todo[inline]{give chapter name here once done}.
