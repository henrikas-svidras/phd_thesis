...
Clearly, the overall shape of the spectrum shifts towards lower-\EB energies after measuring.
...
\begin{figure}[htbp!]
    ...
    Most elements are on the diagonal, meaning that resolution effects are not larger than the photon-energy interval size.
    }
\end{figure}

As it was discussed in \Cref{sec:unfolding}, in this analysis the bin-by-bin correction method is used for unfolding.
It was chosen after testing several more sophisticated unfolding techniques, including those that involve a regularisation of the unfolded result.
