...
\begin{figure}[htbp!]
    ...
    \includegraphics[width=0.45\textwidth]{figures/experimental_setup/clustering1.png}
    }
    \subcaptionbox{\label{fig:clustering2}}{
        \includegraphics[width=0.45\textwidth]{figures/experimental_setup/clustering2.png}
    }
