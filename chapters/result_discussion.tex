...
Interpreting the uncertainties from the partial branching fraction measurement in \Cref{tab:partial_branching_fractions}, this indicates that background and fit modelling uncertainties are large contributors to the systematic uncertainty at lower-\EB thresholds.
...
This is a remarkable achievement given the fact that other type of inclusive \BtoXsgamma analysis techniques are already systematically limited (see \Cref{tab:btosgamma_inclusive_summary}) with the Belle and BaBar datasets.
...
In collaborative effort with the SIMBA collaboration, the results of \Cref{tab:partial_branching_fractions}
...
The fit result, and the comparison of the effect on the total value of the evaluated parameters is shown in \Cref{fig:simba_c7}.
