...
\begin{equation}\label{eq:corr_wilson}
    \mathcal{C}_i^{\mathrm{SM}} \ra \mathcal{C}_i^{\mathrm{SM}} + \mathcal{C}_i^{\mathrm{\BSM}}.
\end{equation}
...
The figures showing next-to-next-to-leading order results are shown in \Cref{fig:2hdm_limits}.
...
It can be seen that $\tan\beta-m_{H^+}$ space is well bounded from type-I and type-II \TwoHDM results.
The strongest bounds arise for type-I \TwoHDM results in the range of $\tan\beta\in(0.4,2)$.
On the other hand, type-II \TwoHDM satureates at high $\tan\beta$ limit.
