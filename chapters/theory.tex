...
As the \BtoXsdgamma (used to collectively identify $X_s$ and $X_d$ states) decay can only proceed via loops, beyond-Standard-Model (BSM) particles can appear in these loops as corrections to the Standard Model calculations.
