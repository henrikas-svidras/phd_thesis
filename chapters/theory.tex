...
\Cref{sec:bphysics_case} will introduce the main points of interest in the study of $B$ meson decays with regards to flavour physics.
...
The bosons of the \SM are summarised in \Cref{tab:standard_model_bosons}.
...
The particles, their spin, charge, mass and known interactions are summarised in \Cref{tab:standard_model_fermions}.
...
There are six vandishing unitarity conditions imposed through \Cref{eq:unitarity} and they can be represented as triangles in the complex plane.
...
A beyond-\SM scenario where this transition is mediated by a charged-Higgs boson particle is shown in \Cref{fig:bsm_diagrams}.
}
\end{figure}
...
In the last Section it was introduced that \BtoXsgamma is important to constrain \SM parameters, such as $m_b$, through the desription of the $B$-meson shape-function and its moments.
