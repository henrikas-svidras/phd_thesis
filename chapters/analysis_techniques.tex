...
\begin{figure}[htpb!]
    ...
    Two-dimensional distributions (red/green) in an example feature space are shown in (\subref{fig:distributions_separation}) for four different example datasets (0-3).
