...
Assuming the requirement of \Cref{eq:likelihood_derivative}, the log-likelihood function can be expanded as a series at $a=\hat{a}$ and approximated as a following parabola:
\begin{equation}
...
In general, this leads to asymmetric uncertainty interval with respect to the central extremum value $\hat{a}_k$ and a different result than uncertainties estimated by the Hessian matrix inversion method.
...
Hence, the \Cref{eq:likelihood_equation}, needs to have a Poissonian term included:
