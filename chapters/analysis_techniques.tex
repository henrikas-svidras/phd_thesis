...
\todo[inline]{Here I also need to have another look to see what I define and where I define it etc.}
\todo[inline]{In general, I don't know, maybe this needs to go after chapter 4? But it gives important stuff like efficiency, purity etc. Dunno.}
