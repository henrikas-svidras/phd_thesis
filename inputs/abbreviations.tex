...
\def\BtoXsdgamma{{\ensuremath{B\rightarrow X_{sd} \gamma}}\xspace}
\def\BtoXsgamma{{\ensuremath{B\rightarrow X_{s} \gamma}}\xspace}
\def\BtoXdgamma{{\ensuremath{B\rightarrow X_{d} \gamma}}\xspace}
\def\BptoXsgamma{{\ensuremath{B^+\rightarrow X_{s} \gamma}}\xspace}
\def\BztoXsgamma{{\ensuremath{B^0\rightarrow X_{s} \gamma}}\xspace}
\def\btosgamma{{\ensuremath{b\rightarrow s\gamma}}\xspace}
\def\BtoKstargamma{{\ensuremath{B\ra \Kstar(892)\g}}\xspace}

\def\clusZMVA{{\ensuremath{\texttt{clusterZernikeMVA}}}\xspace}

\def\piVeto{{\ensuremath{\texttt{pi0Veto}}}\xspace}

\def\etaVeto{{\ensuremath{\texttt{etaVeto}}}\xspace}
